...
7.	Адаптувати код відповідно до патерну Фабричний метод
   ...
   4 варіант
   Додаємо абстрактний клас GeometryFactory та його похідний клас LineFactory, щоб створювати об'єкти типів Line та Hyperplane. Клас GeometryFactory має абстрактні методи CreateLine та CreateHyperplane, які потрібно реалізувати в похідних класах.

LineFactory реалізує ці методи, створюючи нові об'єкти Line та Hyperplane з фіксованими коефіцієнтами.

У методі Main створюється об'єкт LineFactory, з якого потім створюються об'єкти Line та Hyperplane, і виконуються перевірки належності точок відповідно до лінії та гіперплощині. Результати виводяться на консоль.
