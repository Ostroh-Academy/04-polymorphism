...
### Лабораторна робота №4: *Поліморфізм* 
##
**Авторка:** Черній Анастасія

**Варіант №**6

 **1. Проаналізувати роботу програми з віртуальними методами та звичайними. Тобто потрібно дослідити механізм динамічного поліморфізму. Зверніть увагу на приклад коду, зокрема на механізм створення об'єкту одного з класів. На етапі компіляції програми невідомо який вибір зробить користувач під час виконання програми.** 

 *Насправді робота з віртуальними програмами дозволяє переписувати методи для різних класів, що дозволяє розширити об'єм залучених даних та задач до виконання. Це зручно для використання користувачем у випадку наявності розгалуженостей поставленої задачі*
 
 **2. Порівняти результати виконання програми з віртуальними методами та без віртуальних методів. В README файл додати скріншоти роботи програми з віртуальними методами і без віртуальних. Описати різницю.**

*Для поставленої задачі минулої лабораторної роботи, а саме побудови двовимірної та тривимірної матриць випадковим підбором значень або введеня із клавіатури та виведенням їх мінімальних значень, результат не є відмінним. Проте використання віртуальних методів у комбінації з фабричним методом дзволяє створити базовий код, який не складно удосконалити при потребі використання матриць інших розмірностей*

**Виконання коду без використанням віртуальних методів (лаб.№3):**
![image](https://github.com/Ostroh-Academy/04-polymorphism-AChernii/assets/103105210/b5dabea2-28cb-40e1-8f14-033a59d98c91)

**Виконання коду із використанням віртуальних методів (лаб.№4):**
 ![image](https://github.com/Ostroh-Academy/04-polymorphism-AChernii/assets/103105210/fe478184-4e7b-4afb-9cdf-0d510e698582)

**Важливо зазначити, що віртуальний, а зокрема й фабричний, методи дозволяють більш структуровано будувати код та подавати інформацію користувачу.**
