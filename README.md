...
Скріншоти роботи програми з віртуальними методами:
<img width="284" alt="virtual1" src="https://github.com/Ostroh-Academy/04-polymorphism-ViktoriaDenyshchuk/assets/92024304/180a320e-a915-4b56-be5d-e5681afeed85">
<img width="294" alt="virtual2" src="https://github.com/Ostroh-Academy/04-polymorphism-ViktoriaDenyshchuk/assets/92024304/3fb29f50-04f0-41c9-ba4f-e4dc150a5765">

Скріншоти роботи програми без віртуальних методів:
<img width="275" alt="без virtual" src="https://github.com/Ostroh-Academy/04-polymorphism-ViktoriaDenyshchuk/assets/92024304/2a5870b4-1482-48a6-89fe-11b871c34b47">

Різниця між віртуальними методами та без них
З віртуальними методами:
  - Програма використовує поліморфізм, що дозволяє викликати методи підкласу через вказівник на базовий клас.
  - Викликається метод `PrintCoefficients` відповідного підкласу.
  - Точка у 3D просторі обробляється правильно завдяки використанню перевизначеного методу `TransformPoint3D`.

 Без віртуальних методів:
  - Відсутність поліморфізму призводить до того, що викликаються лише методи базового класу.
  - Неправильне виведення коефіцієнтів для 3D трансформацій, якщо методи не перевизначені у підкласах.
  - Образ точки у 3D просторі обробляється менш ефективно.

Використання віртуальних методів дозволяє створювати більш гнучкі та розширювані програми, що можуть обробляти різні типи даних та операцій без зміни базового коду.
